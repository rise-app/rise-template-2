<script>
  export let popular_categories_query = {},
    popular_categories_offers = [],
    popular_categories_offers_total = 0,
    popular_categories_offers_offset = 0,
    popular_categories_offers_limit = 10
